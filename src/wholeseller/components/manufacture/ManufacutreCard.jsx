        ...
        <div>
            ...
            <div className="flex gap-0.5 justify-between items-center">
                ...
                <div className="flex gap-2 md:gap-5 items-center ">
                    ...
                    {/* Company Name */}
                    <div>
                        <h1 className="text-sm md:text-xl text-gray-700 hover:text-gray-900 cursor-pointer font-semibold">
                ...
                <div>
                    {/* Chat Now Button */}
                    <button className="bg-gray-700 text-sm md:text-base rounded-full shadow-md text-white  px-3 md:px-5 py-1 hover:bg-gray-500">
                        Chat Now
                    </button>
